...
namespace Watertight.Framework.Components
{
    public class SceneComponent : ActorComponent, ITransformable
    {
        ...
        {
            Vector3 ParentWS = Parent?.GetLocation_WorldSpace() ?? Owner.Location;                  
        ...
        {
            Quaternion ParentWS = Parent?.GetRotation_WorldSpace() ?? Owner.Rotation;
        ...
        {
            Vector3 ParentWS = Parent?.GetScale_WorldSpace() ?? Owner.Scale;
